...
Round 4 finding: weight transformations (AWQ, outlier clipping, bias
correction) all hurt HQQ quality. The simplest pipeline is the best.
"""
...
def optimize_model(model_name: str, device: str = "cuda"):
    ...
    # Quantize with torchao int4 HQQ — streaming layer by layer
    print("Quantizing...")
